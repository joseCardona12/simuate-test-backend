...
var Like = function () {
    ...
    var Like = _classThis = /** @class */ (function (_super) {
        ...
        function Like_1() {
            ...
            _this.quantity = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _quantity_initializers, void 0));
            _this.post_id = (__runInitializers(_this, _quantity_extraInitializers), __runInitializers(_this, _post_id_initializers, void 0));
            __runInitializers(_this, _post_id_extraInitializers);
            return _this;
        }
        return Like_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _post_id_decorators = [(0, sequelize_typescript_1.ForeignKey)(function () { return postModel_1.default; }), (0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.INTEGER,
                allowNull: false
            })];
